  ...
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden 
      ...
      <div className="flex-1 flex items-center justify-center px-4 relative z-10">
        <div className="w-full max-w-xl bg-white/5 backdrop-blur-md 
                        border border-white/10 rounded-2xl p-10 shadow-lg text-center">
          ...
          {/* Upload box */}
          <div className="border-2 border-dashed border-gray-500/40 rounded-xl p-10 
                          hover:border-indigo-400 transition mb-6">
            ...
            <label className="inline-block cursor-pointer">
              ...
              />
              <span className="px-6 py-3 rounded-lg bg-gradient-to-r from-indigo-400 to-emerald-400 
          ...
          {uploaded && (
            <motion.div
              ...
              className="mt-6 p-4 bg-emerald-500/20 border border-emerald-400/30 rounded-lg text-white"
            >
